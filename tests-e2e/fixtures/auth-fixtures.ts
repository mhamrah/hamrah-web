...
export const testData = {
  ...
  googleUser: {
    ...
    idToken:
      "eyJhbGciOiJSUzI1NiIsImtpZCI6InRlc3Qta2V5LWlkIn0.eyJpc3MiOiJhY2NvdW50cy5nb29nbGUuY29tIiwiYXVkIjoidGVzdC1nb29nbGUtY2xpZW50LWlkIiwic3ViIjoiMTIzNDU2Nzg5MCIsImVtYWlsIjoidGVzdEBnbWFpbC5jb20iLCJuYW1lIjoiVGVzdCBVc2VyIiwiaWF0IjoxNjQwOTk1MjAwLCJleHAiOjE2NDA5OTg4MDB9.test-signature",
  },
};
...
export class AuthPage {
  ...
  async mockGoogleOAuth() {
    ...
    await this.page.route("**/auth/google", async (route) => {
      ...
      await route.fulfill({
        ...
        headers: {
          Location:
            "/auth/google/callback?code=mock-google-auth-code&state=mock-state",
        },
      });
    });
  ...
  async waitForAuthRedirect() {
    await this.page.waitForURL(
      (url) => url.pathname === "/" || url.searchParams.has("auth"),
    );
  }
