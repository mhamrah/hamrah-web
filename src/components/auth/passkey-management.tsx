...
export const PasskeyManagement = component$<PasskeyManagementProps>(
  (props) => {
    ...
    const addPasskey = $(async () => {
      ...
      try {
        ...
        error.value = err instanceof Error ? err.message : "Failed to add passkey";
      } finally {
        isAdding.value = false;
      }
    });
    ...
    const deletePasskey = $(async (credentialId: string) => {
      ...
      try {
        ...
        error.value = err instanceof Error ? err.message : "Failed to delete passkey";
      }
    });
    ...
    const savePasskeyName = $(async (credentialId: string) => {
      ...
      try {
        ...
        error.value = err instanceof Error ? err.message : "Failed to rename passkey";
      }
    });
                      ...
                      {editingPasskey.value === passkey.id ? (
                        <div class="flex items-center space-x-2">
                          <input
                            ...
                            class="rounded border-gray-300 px-2 py-1 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                          />
                          <button
                            type="button"
